  ...
  const renderWalletStep = () => (
    <View className="flex-1 justify-center items-center px-6">
      ...
      <Text className="text-3xl font-bold text-white text-center mb-4">
        {isCreatingAccount ? "Create Your Wallet" : "Import Your Wallet"}
      </Text>
      ...
      <TouchableOpacity
        ...
        disabled={isProcessing || (!isCreatingAccount && !mnemonic.trim())}
        ...
        {isProcessing ? (
          ...
          <>
            ...
            <Text className="text-white font-semibold text-lg ml-2">
              {isCreatingAccount ? "Create Wallet" : "Import Wallet"}
            </Text>
          </>
        )}
      </TouchableOpacity>
  ...
  const renderUsernameStep = () => (
    <View className="flex-1 justify-center items-center px-6">
      ...
      <TouchableOpacity
        ...
        className={`rounded-xl py-4 px-8 w-full flex-row items-center justify-center ${
          isProcessing || !username.trim() ? "bg-gray-600" : "bg-accent"
        }`}
      >
        {isProcessing ? (
          <ActivityIndicator color="white" size="small" />
